...
public class Board {
	...
	// change les valeurs du tableau sans prendre en compte si elle �taient déjà distribuées
	public void shuffle() {
		int trois = 10;
		int deux = 20;
		int un = 30;
	...
	// si le déplacement n'était pas valide la tuile retourné est null et aucune modification du plateau n'est faites
